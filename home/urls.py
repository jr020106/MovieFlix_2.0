...
urlpatterns = [
    ...
    path('dhamaal/', views.dhamaal, name='dhamaal'),
    path('herapherii/', views.herapherii, name='herapherii'),
    path('dostana/', views.dostana, name='dostana'),
    path('bandbaajabaaraat/', views.bandbaajabaaraat, name='bandbaajabaaraat'),
    path('kalki/', views.kalki, name='kalki'),
    path('maverick/', views.maverick, name='maverick'),
    path('yodha/', views.yodha, name='yodha'),
    path('thematrixresurrections/', views.thematrixresurrections, name='thematrixresurrections'),
    path('war/', views.war, name='war'),
    path('dopatti/', views.dopatti, name='dopatti'),
    path('joker/', views.joker, name='joker'),
    path('idiots3/', views.idiots3, name='idiots3'),
    path('munjya', views.munjya, name='munjya'),
]
